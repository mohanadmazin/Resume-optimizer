...
An Edge window will open at an Indeed job search page. Wait for the
"Just a moment..." check to finish and the real page to load (this is
usually automatic, a few seconds - if it shows an interactive
...
# If your Edge install is somewhere non-standard, just hardcode the
...
def _find_edge_executable() -> str:
    ...
    raise FileNotFoundError(
        "Could not find Microsoft Edge automatically. Set EDGE_PATH_OVERRIDE "
        "at the top of this file to Edge's full executable path (right-click "
        "the Edge shortcut -> Properties -> Target, or find it in your "
...
def main():
    ...
    with sync_playwright() as p:
        ...
        print("\nAn Edge window has opened at Indeed.")
